...
private:
   ...
   const static float xMin = -400; // minimum extent of the x position
   const static float xMax =  400; // maximum extent of the x position
   const static float yMin = -400; // minimum extent of the y position
   const static float yMax =  400; // maximum extent of the y position
};
